...
# @Software : PyCharm
import numpy as np
from EnsembleDynamicsModel import EnsembleDynamicsModel
...
class PETS:
    ...
    def __init__(self, env, replay_buffer, n_sequence, elite_ratio,
                 plan_horizon, num_episodes, device):
        self.device = device
        self._env = env
        ...
        self._model = EnsembleDynamicsModel(obs_dim, self._action_dim, self.device)
    ...
    def train_model(self):
        ...
        env_samples = self._env_pool.all_sample()
        obs = env_samples[0]
