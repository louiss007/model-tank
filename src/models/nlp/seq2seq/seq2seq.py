...
'''
Note: 基本seq2seq模型，encoder和decoder均使用LSTM，没有attention
bianmaqi可选shuangxiang
zhichidecell类型
zhichidechaocansousuo方法: greedy或者beam_search
'''
...
class Seq2SeqModel(object):
    ...
    def __init__(self, model_path=None, *, src_vocab_size=None, tgt_time_step=None, tgt_vocab_size=None,
                 start_token_id=None, end_toekn_id=None):
        # 1.如果传入模型路径，尝试加载模型
    ...
    def train(self, model_path, generator, src_embedding_size, tgt_embedding_size, is_encoder_bidirectional=False,
        ...
        train_graph = self.build_graph(src_embedding_size, tgt_embedding_size, is_encoder_bidirectional, rnn_layer_size,
                                       rnn_num_units, cell_type, lr, decoding_method, beam_width)
